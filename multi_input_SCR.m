...
%set SCR units
nInputUnits = 2; nInternalUnits = 100; nOutputUnits = 1; 
...
%multi-input
[inputSequence outputSequence] = generate_NARMA_sequence_m(sequenceLength , systemOrder, nInputUnits, corrMat);
...
esn = generate_esn(nInputUnits, nInternalUnits, nOutputUnits, ...
    'spectralRadius',0.5,'inputScaling',repmat(0.1,nInputUnits,1),'inputShift',repmat(0,nInputUnits,1), ...
